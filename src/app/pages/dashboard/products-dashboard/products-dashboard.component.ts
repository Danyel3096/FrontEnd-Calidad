  ...
  initDataTable(): void {
    this.dataTable = $('#productsTable').DataTable({
      ...
      initComplete: () => {
        ...
        //const btnHtml = `<button id="btnAddProduct" class="btn btn-success btn-sm ms-2"><i class="fas fa-plus"></i> Crear usuario</button>`;
        const btnHtml = `<button id="btnAddProduct" class="btn btn-success mb-1"><i class="fas fa-plus"></i> Crear usuario</button>`;
